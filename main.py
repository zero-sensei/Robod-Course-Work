...
optimal_k = 5
result = cluster_analysis.perform_clustering(X_scaled, optimal_k)

cluster_analysis.visualize_clusters()

export_result = result.sort_values(by=['Cluster'], ascending=False)
export_result.to_excel('output.xlsx', index=False)
